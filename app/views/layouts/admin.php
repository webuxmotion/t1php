...
?>" target="_blank" class="logo">
            ...
            <span class="logo-lg"><b>SEE SITE</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?=ADMIN ?>/user"><i class="fa fa-user"></i> <span>Пользователи</span></a></li>

                <li><a href="<?=ADMIN ?>/lang"><i class="fa fa-language"></i> <span>Языки</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
...
if (DEBUG)
{
  $logs = \R::getDatabaseAdapter()->getDatabase()
    ->getLogger();
